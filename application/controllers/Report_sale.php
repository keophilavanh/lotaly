...
class Report_sale extends CI_Controller{
    ...
    public function index(){
         ...
         if($this->Employee_model->check_token())
         {
            ...
            $this->load->view('conten/sale/view_select_report_sale',$data,false);
        }
        ...
        if($this->Employee_model->check_token())
         {
            ...
            $this->load->view('conten/sale/view_Ticket_Sale',$data,false);
         }
    }
        ...
        if($this->Employee_model->check_token())
         {
            ...
            $fetch_data = $this->Report_Sale_model->make_datatables(2);  
            $data = array();  

            if($this->Report_Sale_model->get_all_data() > 0){
            ...
            $output = array(  
                ...
                "recordsTotal"          =>      $this->Report_Sale_model->get_all_data(),  
                "recordsFiltered"     =>     $this->Report_Sale_model->get_filtered_data(),  
                "data"                    =>     $data  
            );  
