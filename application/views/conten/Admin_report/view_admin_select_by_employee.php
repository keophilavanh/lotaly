    ...
    <div class="content p-4">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <h2 class=" text-center">ລາຍງານການຂາຍຕາມພະນັກງານ</h2>
                <br/>
                <div class=" row text-center">
                    <div class="col-mb-4 col-lg-4"></div>

                    <div class="mb-6 col-xs-4 col-lg-4">

                        <div class="input-group ">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="basic-addon1">ເລືອກພະນັກງານ</span>
                                </div>
...
<script type="text/javascript" language="javascript" >  
 ...
 $(document).ready(function(){  
    ...
    $(document).on('click', '#reface', function(){
         ...
         console.log('sd');
            window.location.href = link+'Report-Sale-by-Employee-Periods/'+id+'/'+user_id;
       });
